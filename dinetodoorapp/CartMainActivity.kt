...
import com.example.cart.istener.IDrinkLoadListener
...
abstract class CartMainActivity : AppCompatActivity(), IDrinkLoadListener,ICartLoadListener {
            ...
            .addListenerForSingleValueEvent(object:ValueEventListener{
                override fun onDataChange(snapshot: DataSnapshot) {
                    if (snapshot.exists()) {
                        ...
                        drinkLoadListener.onDrinkLoadFailed("Beverage doesn't exist")
                }
    ...
    private fun init(){
      ...
      //  recycler_drink.layoutManager = gridLayoutManager
       ...
       // btnCart.setOnClickListener { startActivity(Intent(this,DrinkModel::class.java)) }
